...
public class BudgetDetailFragment extends DialogFragment {
    ...
    View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (id == R.id.category_detail_dialog_cancel) {
                dismiss();

            } else if (id == R.id.category_delete) {
                if (exCategory_id == 1) {
                    AlertDialog.Builder delete_builder = new AlertDialog.Builder(getActivity());
                    delete_builder.setMessage("You cannot delete default category")
                ...
                if (newName.isEmpty() || newName.trim().length() == 0) {
                    ...
                    edit_builder.setMessage("Category name cannot be empty")
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    dialogInterface.dismiss();
                ...
                if (category_amount.getText().toString().trim().length() == 0) {
                    ...
                    try {
                        newAmount = BigDecimalCalculator.roundValue(
                                Double.parseDouble(category_amount.getText().toString()), currencyCode);
                    } catch (Exception e) {
                        newAmount = BigDecimalCalculator.roundValue(0.0, currencyCode);
                    }
                }
    ...
    private void promptChooseAnotherCategory() {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                if (i == R.id.radio_delete) {
                    categoryChooseSpinner.setVisibility(GONE);
                } else if (i == R.id.radio_move) {
        ...
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (selectedId == R.id.radio_delete) {
                    deleteBelongingTransactions();
                } else if (selectedId == R.id.radio_move) {
