...
import static com.example.quanlychitieu.AddingCreditActivity.SELECT_DATE;
import static com.example.quanlychitieu.AddingCreditActivity.SELECT_DUE_VALUE;
import static com.example.quanlychitieu.AddingCreditActivity.SELECT_END_VALUE;
import static com.example.quanlychitieu.AddingCreditActivity.SELECT_START_VALUE;
...
public class ShowingCreditDetailActivity extends AppCompatActivity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.credit_menuItem_edit) {
            updateCard();
            return true;

        } else if (id == R.id.credit_menuItem_delete) {
            deleteCard();
            return true;

        } else if (id == R.id.credit_menuItem_pay) {
    ...
    View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            } else if (id == R.id.credit_cycle_start) {
            ...
            } else if (id == R.id.credit_cycle_end) {
